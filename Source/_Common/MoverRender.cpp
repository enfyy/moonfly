...
// Render Guild Name & Logo
    ...
    if( pGuild->m_nLevel >= 50 )
        dwColor = COLOR_GUILD_NAME_50;    // 50
    else if( pGuild->m_nLevel >= 40 )
        dwColor = COLOR_GUILD_NAME_40;    // 40
    else if( pGuild->m_nLevel >= 30 )
        dwColor = COLOR_GUILD_NAME_30;    // 30
    else if( pGuild->m_nLevel >= 20 )
        dwColor = COLOR_GUILD_NAME_20;    // 20
    else if( pGuild->m_nLevel >= 10 )
        dwColor = COLOR_GUILD_NAME_10;    // 10
#endif // __GUILD_COLOR  
